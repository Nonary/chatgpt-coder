...
contextBridge.exposeInMainWorld('patchwork', {
  ...
  addWorkspaceRepositories: (repositoryPaths) => ipcRenderer.invoke('workspace:add', repositoryPaths),
  ...
  gitSummary: (repositoryPath, customPrompt, chatgptProject, model) => (
    ipcRenderer.invoke('git:summary', repositoryPath, customPrompt, chatgptProject, model)
  ),
