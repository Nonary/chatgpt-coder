...
contextBridge.exposeInMainWorld('patchwork', {
  ...
  getTaskChat: (taskId) => ipcRenderer.invoke('task:chat', taskId),
  sendTaskChatMessage: (taskId, text, configuration) => ipcRenderer.invoke('task:chat-send', taskId, text, configuration),
  stopTaskChat: (taskId) => ipcRenderer.invoke('task:chat-stop', taskId),
