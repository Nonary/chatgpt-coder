(() => {
  ...
  if (window[INSTALL_KEY]) {
    window.alert('Patchwork proxy compatibility is already active in this tab.');
    return;
  }
  ...
  window.alert('Patchwork proxy compatibility enabled for this ChatGPT tab until refresh.');
})();
